    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed inset-0 z-9999 bg-slate-900 flex items-center justify-center overflow-hidden h-screen"
        >
          ...
          <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto px-4">
            ...
            <motion.div
              ...
              className="w-full max-w-2xl bg-slate-800/80 backdrop-blur-md rounded-lg border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 overflow-hidden mb-8"
            >
              {/* Terminal Header */}
              <div className="flex items-center gap-2 px-4 py-3 bg-slate-900/50 border-b border-cyan-500/20">
